...
<body
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Congratulations on starting your journey with {{config('app.name')}}. We’re
                                            excited you’re
                                            here and can’t wait to help you get started
                                            on your entrepreneurial journey. <br></p>
                                        <div style="text-align: center;">
                                            <a href="{{env('APP_WEB')}}" class="button button-blue" target="_blank"
                                        ...
                                        <p
                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 16px; line-height: 1.5em; margin-top: 18px; text-align: left;">
                                            Complete your registration
                                            You’re this close to selling online with {{config('app.name')}}. Complete
                                            your registration now to start selling and ship your
                                            products and services with ease. <br></p>
                                        <div style="text-align: center;">
                                            <a href="{{env('APP_WEB')}}" class="button button-blue" target="_blank"
                                                style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); color: #ffffff; display: inline-block; text-decoration: none; -webkit-text-size-adjust: none; background-color: #3097d1; border-top: 10px solid #3097d1; border-right: 18px solid #3097d1; border-bottom: 10px solid #3097d1; border-left: 18px solid #3097d1;">
    ...
    <table class="subcopy" width="100%" cellpadding="0" cellspacing="0"
        style="border:none;font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 25px;">
        <tr>
            <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                <p
                    style="border:none;font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; line-height: 1.5em; margin-top: 0; text-align: center; font-size: 12px;">
                    If you’re feeling stuck, we recommend checking out our Help Center. You can also contact our live
                    support.</p>
            </td>
        </tr>
    </table>
